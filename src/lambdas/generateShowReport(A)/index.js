...
try {
    ...
    let result = venuesAndShows.reduce((acc, { venueName, showName, proceedings, remainingSeats, soldSeats }) => {
    acc[venueName] = acc[venueName] || [];
    acc[venueName].push({ showName, proceedings, remainingSeats, soldSeats });
    return acc;
    }, {});
